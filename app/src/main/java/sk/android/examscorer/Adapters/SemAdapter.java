...
import sk.android.examscorer.Activity.SubjecstActivity;
...
public class SemAdapter extends RecyclerView.Adapter<SemAdapter.Viewholder> {
    ...
    public SemAdapter(List<CommonModel> list, Context context, String branch_id, String title) {
        this.list = list;
    ...
    public SemAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Viewholder(LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_semester_layout,parent,false));
    }
        ...
        public void getData(int position) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("branch_title",title);
