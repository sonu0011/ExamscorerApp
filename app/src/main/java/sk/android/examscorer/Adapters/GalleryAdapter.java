...
public class GalleryAdapter extends RecyclerView.Adapter<GalleryAdapter.MyViewHolder> {
    ...
    private List<AnotherCommonModel> images;
    ...
    public GalleryAdapter(Context context, List<AnotherCommonModel> images) {
        mContext = context;
        this.images = images;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        Glide.with(mContext).load(image.getNotes_download_link1())
                .thumbnail(0.5f)
                .crossFade()
