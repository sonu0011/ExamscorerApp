...
import sk.android.examscorer.Activity.SemesterActivity;
        ...
        public void getData(int position) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("branch_title",model.getBranch_title());
                    intent.putExtra("branch_heading",model.getBranch_heading());
